...
<body class="mobile">
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="text" id="expiry-date" name="expiry-date" pattern="(0[1-9]|1[0-2])\/[0-9]{4}" placeholder="MM/YYYY" required>
        </div>
        <div class="form-group">
            <label for="cvv">CVV:</label>
            <input type="number" id="cvv" name="cvv" pattern="[0-9]{3,4}" required>
        </div>
